...
//  upright % as a large, light-weight numeral inside. The score builds
//  naturally from 0 % as the day progresses. When snoozed, the number is
//  replaced by a pause button that taps to resume.
//
...
struct StatusRing: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Inner numeral (or snooze pause button).
            VStack(spacing: 6) {
                if isSnoozed {
                    pauseButton
                } else {
